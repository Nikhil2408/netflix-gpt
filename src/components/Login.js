...
import { BG_NETFLIX_PAGE } from '../utils/constants';
...
const Login = () => {
  ...
  return (
    <div>
        <Header page = "Login" />
        <div>
            <img src={BG_NETFLIX_PAGE} alt = "Bg_netflix" />
        </div>
        <div className='absolute top-1/4 bg-black  bg-opacity-85 mx-auto border-2'>
